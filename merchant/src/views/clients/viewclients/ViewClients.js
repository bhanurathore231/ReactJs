          ...
          <CCol xs={9}>
            ...
            <CListGroup flush>
              <CListGroupItem className="group-item-profile-page">
                Spend Amount:<h4 className="client-count-profile-page">${totalamount}</h4>
              </CListGroupItem>
              <CListGroupItem className="group-item-profile-page">
                Email:<h4 className="client-count-profile-page">{result.email}</h4>
              </CListGroupItem>
              <CListGroupItem className="group-item-profile-page">
                Phone:<h4 className="client-count-profile-page">{result.phone}</h4>
              </CListGroupItem>
            </CListGroup>
          </CCol>
        </CCol>
