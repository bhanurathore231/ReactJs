...
import { cibFacebook, cibYoutube, cibInstagram, cibTiktok } from '@coreui/icons'
    ...
    <CRow>
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsD
          ...
          values={[{ title: 'subscriber', value: '973k' }]}
          style={{
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsD
          ...
          values={[{ title: 'followers', value: '500' }]}
          style={{
      ...
      <CCol sm={6} lg={3}>
        <CWidgetStatsD
            ...
            chart: (
              <CChart
                ...
                data={{
                  ...
                  datasets: [
                    {
                      backgroundColor: 'rgba(254,218,117)',
                      borderColor: 'rgba(255,255,255,.55)',
                      pointHoverBackgroundColor: '#fff',
                      borderWidth: 2,
          ...
          values={[{ title: 'followers', value: '121' }]}
        />
      </CCol>
    </CRow>
  )
